defmodule CalderaodeartesdavobruxaWeb.OpinionLive.Show do
  ...
  @impl true
  def handle_info(
        {:updated, %Calderaodeartesdavobruxa.Accounts.Opinion{id: id} = opinion},
  ...
  def handle_info(
        {:deleted, %Calderaodeartesdavobruxa.Accounts.Opinion{id: id}},
        %{assigns: %{opinion: %{id: id}}} = socket
      ) do
    {:noreply,
     socket
